...
# Write combined spec WITHOUT auth with warning header
warning_header = """# ⚠️  AUTO-GENERATED FILE - DO NOT EDIT MANUALLY ⚠️
#
# This file is automatically generated by merge-openapi.py
# To make changes, edit the source files:
#   - api/openapi/workitems.yaml
#   - api/openapi/sprints.yaml
#
...
# Write combined spec WITH auth with warning header
warning_header_with_auth = """# ⚠️  AUTO-GENERATED FILE - DO NOT EDIT MANUALLY ⚠️
#
# This file is automatically generated by merge-openapi.py
# To make changes, edit the source files:
#   - api/openapi/workitems.yaml
...
with open(script_dir / 'api/openapi/combined-with-auth.yaml', 'w') as f:
    f.write(warning_header_with_auth)
